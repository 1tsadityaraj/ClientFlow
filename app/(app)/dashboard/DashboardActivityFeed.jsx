            ...
            return (
              <div key={log.id} className="flex items-center gap-3 group">
                <div className="relative shrink-0">
                  ...
                  <span 
                    className="absolute -bottom-0.5 -right-0.5 flex h-3 w-3 items-center justify-center rounded-full bg-zinc-950 text-[7px] border border-zinc-900"
                    style={{ color }}
                  >
                    {icon}
                  </span>
                ...
                <div className="min-w-0 flex-1 flex items-baseline justify-between gap-2">
                  <p className="truncate text-xs text-zinc-400">
                    <span className="font-medium text-zinc-200 mr-1">{log.user?.name}</span>
                    {description}
                  </p>
